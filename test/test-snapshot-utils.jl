...
Test.@test( typeof(OrganizationSnapshots.Utils.git_version()) <: VersionNumber )
Test.@test( typeof(OrganizationSnapshots.Utils.get_all_branches_local()) <: Vector{String} )
Test.@test( typeof(OrganizationSnapshots.Utils.get_all_branches_local_and_remote()) <: Vector{String} )
Test.@test( typeof(OrganizationSnapshots.Utils.get_current_branch()) <: String )
Test.@test( OrganizationSnapshots.Utils.branch_exists("branch1") )
Test.@test( !OrganizationSnapshots.Utils.branch_exists("non-existent-branch") )
Test.@test( !OrganizationSnapshots.Utils.branch_exists("non-existent-but-create-me") )
Test.@test( typeof(OrganizationSnapshots.Utils.checkout_branch!("branch1")) <: Nothing )
Test.@test_throws(
    ErrorException,
...
Test.@test_warn(
    "",
    OrganizationSnapshots.Utils.checkout_branch!("non-existent-branch"; error_on_failure=false,),
    )
Test.@test(
    typeof(
        OrganizationSnapshots.Utils.checkout_branch!("non-existent-but-create-me"; create=true)
        ) <: Nothing
    )
OrganizationSnapshots.Utils.git_add_all!()
OrganizationSnapshots.Utils.git_commit!(
...
Test.@test( typeof(OrganizationSnapshots.Utils.git_push_upstream_all!()) <: Nothing )
...
branches_to_snapshot = OrganizationSnapshots.Utils.make_list_of_branches_to_snapshot(
    ;
